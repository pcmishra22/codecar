...
<h3 class="muted"><?php echo Yii::app()->name ?></h3>
</div>
...
<?php echo Yii::t("app", "Developed by {Developer}", array(
	"{Developer}" => '<strong><a href="http://php5developer.com">PHP5 Developer</a></strong>',
)); ?>
<? if(Yii::app()->params['showPagepeekerCopyright']): ?>
    &nbsp;|&nbsp;
