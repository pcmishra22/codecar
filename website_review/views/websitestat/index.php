...
<div class="row-fluid">
    ...
    <div class="span9">
        <div class="row-fluid">
            <div class="span6">
                <img class="thumbnail" id="thumb_main_<?php echo $website['id'] ?>" src="<?php echo Yii::app() -> getBaseUrl(true) ?>/img/loader.gif" alt="<?php echo $website['idn'] ?>" />
            </div>
            <div class="span6">
        ...
        <h4 id="page_speed"><?php echo Yii::t("app", "Page speed") ?></h4>
        <hr>
